...
class List3Activity : ComponentActivity() {
    // Lista de artículos
    val listado : List<Articulo> = listOf(
        Articulo(R.drawable.totolera, "Tortolera", "Precio: Q200"),
        Articulo(R.drawable.gallinera, "Gallinera", "Precio: Q350"),
        Articulo(R.drawable.comederoperro, "Plato", "Precio: Q80"),
        Articulo(R.drawable.pecera, "Pecera", "Precio: Q5000")
    )
...
@Composable
fun Pantalla3(listado: List<Articulo>) {
...
@Composable
fun ListItemRow3(item: Articulo) {
    // Contexto actual
